    ...
    <section className="container grid grid-cols-12 font-poppins items-center ">
      ...
      <div className=" col-span-6 z-20 space-y-14">
        <div className=" space-y-4">
          <h1 className="text-[#F09804] font-bold text-6xl  font-bernier uppercase">
            Contacter Nous
          </h1>
          <h2 className="text-4xl ">contactez-nous directement.</h2>
        </div>

        <p className="text-[#D4D4D4] leading-7 w-[452px]">
        ...
        <div className="flex gap-5">
          ...
          <h4 className="text-2xl">
            +212 5288-21819
            <br /> <span className="text-[#C4C4C4] text-sm">Téléphone</span>
          </h4>
        </div>
        <div className="flex gap-5">
          <Image
